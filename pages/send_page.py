...
class Locators:
    ...
    PHONE_NUMBER_OF_YHE_SENDER = (By.XPATH,
...
class SendPage(BasePage):
    ...
    def button_send_package(self):
        click_send_package = self.driver.find_element(*Locators.BUTTON_SEND_PACKEG)
    ...
    def choose_size_of_packed(self):
        try:
    ...
    def enter_data_of_customer(self):
        self.driver.find_element(*Locators.NAME_AND_SURNAME_OF_THE_RECIPIENT).send_keys("Jan Testowy")
        self.driver.find_element(*Locators.E_MAIL_OF_THE_RECIPIENT).send_keys("test@test.pl")
        self.driver.find_element(*Locators.PHONE_NUMBER_OF_THE_RECIPIENT).send_keys("600600600")
        self.driver.find_element(*Locators.ADDRESS_PACZKOMAT_OF_THE_RECIPIENT_SECTION).send_keys("Nowe")
    ...
    def enter_data_of_sender(self):
        self.driver.find_element(*Locators.NAME_AND_SURNAME_OF_THE_SENDER).send_keys("Tomek Testowy")
        self.driver.find_element(*Locators.E_MAIL_OF_THE_SENDER).send_keys("testujemy@op.pl")
        self.driver.find_element(*Locators.PHONE_NUMBER_OF_YHE_SENDER).send_keys("500500500")
